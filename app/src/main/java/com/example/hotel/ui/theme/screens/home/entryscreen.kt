...
import com.example.hotel.navigation.Route_register
import com.example.hotel.navigation.Route_view_rooms

@Composable
fun EntryScreen(navController: NavController){
    Box(modifier = Modifier.fillMaxSize()) {
        Image(painter = painterResource(id = R.drawable.build2
        ),
        ...
        Column(modifier = Modifier.fillMaxSize(),
            ...
            Text(text = "Lux Hotel", fontSize = 60.sp,
                fontFamily = FontFamily.Cursive,
                textAlign = TextAlign.Center,
                color = Color.White,
                fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(70.dp))
            Text(text ="Your Perfect Stay, Just a Tap Away!" , fontSize = 30.sp,
