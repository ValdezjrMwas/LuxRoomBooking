package com.example.hotel.ui.theme.screens.register
...
import com.example.hotel.data.AuthViewModel
import com.example.hotel.navigation.Route_login

@Composable
fun RegisterScreen(navController: NavController){
    Box(modifier = Modifier.fillMaxSize()){
        Image(painter = painterResource(id = R.drawable.registerpic2
        ),
...
//            .background(Color.Cyan)
            ...
            ImageComponent()
            Text(text = "Welcome to Lex Hotel",
                color = Color.Black,
